...
## Project Structure
    ...
    ├── juansharedatamodels_1  # Django project configurations
...
1. Clone this repo and `cd juansharedatamodels_1`
...
2. Clone this repo and `cd juansharedatamodels_1`
