"""
Django settings for juansharedatamodels_1 project.
...
ROOT_URLCONF = 'juansharedatamodels_1.urls'
...
WSGI_APPLICATION = 'juansharedatamodels_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juansharedatamodels_1 API",
    "DESCRIPTION": "API documentation for juansharedatamodels_1 App",
    "VERSION": "v1",
}
